...
将文件重命名为 `dns-over-https.mobileconfig` 后下载到 IOS 设备，然后在 IOS 设备进入 **设置** → **通用** →  **VPN 与设备管理**，找到证书（显示为 `EMAS HTTPDNS DoH Configuration`)，点击安装
...
- [macOS中或iOS等苹果系统中使用DNS over HTTPS(DoH)保护你的网络隐私](https://www.lvtao.net/system/apple-macos-ios-doh-dns-over-https.html)